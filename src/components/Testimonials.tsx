              ...
              {testimonials.map((t, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-6 w-14 h-14 rounded-full bg-[#EDEDED] border-2 border-[#E4007C]">
                      {t.avatar && (
                        <img
                          src={t.avatar}
                          alt={t.name}
                    ...
                    {t.name && <p className="mt-3 font-bold text-sm text-[#111111]">{t.name}</p>}
                    {t.title && <p className="text-xs text-[#111111]/60 mt-1">{t.title}</p>}
                  </motion.div>
                );
              })}
            </AnimatePresence>
